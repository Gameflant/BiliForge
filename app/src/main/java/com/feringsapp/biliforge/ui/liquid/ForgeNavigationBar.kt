...
private fun rememberGravityRotatedHighlight(
    ...
    // 性能模式：陀螺仪光斑关闭时返回静态高光（避免传感器 50Hz 刷新导致重绘）
    if (!LiquidGlassConfig.tiltLightEnabled) {
        return remember { mutableStateOf(base) }
    }
...
fun ForgeLiquidNavBar(
    ...
    ForgeLogger.render("ForgeLiquidNavBar")
